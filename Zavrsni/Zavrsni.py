...
def main ():
    ...
    #Svabo = neprijatelj(grid, VisinaProzora, SirinaProzora, start, kraj, POVRSINA, 5, U, (100, 5, 9))
    UI = sucelje(VisinaProzora, SirinaProzora, grid, POVRSINA, startGold)
    mousex = 0
    mousey = 0
    ...
    while True:
        ...
        #UI.menu(menuSlika, toranj1ikona)
